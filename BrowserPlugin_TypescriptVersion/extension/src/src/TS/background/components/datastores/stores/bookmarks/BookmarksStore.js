...
const DBReportingManager_1 = require("../../components/parts/abstract_object_store_parts/layers/layer2_reporting/DBReportingManager");
...
class BookmarksCollectionBuildingManager {
    constructor() {
        this.collectionDatabaseAndTableSetup = (0, BuildDBConstructionActions_1.GetCreateDBStoreHandler)("BookmarksStore", {
            indexName: Types_1.KEY_NAME, indexKeyPath: "key",
            options: { unique: true }
        });
