...
const DB_1 = __importDefault(require("../../../abstract/parts/layers/layer0_db/DB"));
...
class AutoAnnotatorSetupsStoreBuildingManager {
    constructor() {
        ...
        this.constructionProcedure = () => (0, DBCache_Types_1.builder)("WebpageTags", 1, "TagsCollection", this.collectionDatabaseAndTableSetup, AutoAnnotatorStore).then(tagsCollectionInstance => {
