...
const StoreObject_Constants_1 = require("../../../layers/layer0_db/store_object/StoreObject_Constants");
function GetCreateDBStoreHandler(storeName, ...indexesToCreate) {
    return (event) => {
        let objectStore = event.currentTarget.result.createObjectStore(storeName, { keyPath: StoreObject_Constants_1.ID_NAME, autoIncrement: true });
