...
exports.builder = exports.DBWithCacheWithReportingOfAllOperationsOnData = exports.DBWithCacheWithOptionalReportingOfInsertedObjects = exports.DBWithCacheWithReportingOfInsertedObjects = exports.DBWithCacheWithReporting = void 0;
...
class DBWithCacheWithReportingOfInsertedObjects extends DBWithCacheWithReporting {
    ...
    addObject(storeObject) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            return yield _super.addObject.call(this, storeObject).then(objectId => {
                storeObject.id = objectId;
                let newObjectReport = storeObject;
...
class DBWithCacheWithOptionalReportingOfInsertedObjects extends DBWithCacheWithReporting {
    constructor(storeName, db, areReportingAllChanges = false) {
        super(storeName, db, areReportingAllChanges);
    }
    addObject(storeObject) {
        if (this.checkIfStoreObjectShouldBeReported(storeObject)) {
            return super.addObject(storeObject).then(objectId => {
                storeObject.id = objectId;
                let newObjectReport = storeObject;
                this.reportingManager.reportAddObject(objectId, newObjectReport);
                return objectId;
...
exports.DBWithCacheWithOptionalReportingOfInsertedObjects = DBWithCacheWithOptionalReportingOfInsertedObjects;
...
function builder(DATABASE, DB_VERSION, STORE_NAME, createDBStore, objectToBuild) {
    return __awaiter(this, void 0, void 0, function* () {
        let createDBPromise = yield BuildDB_1.CreateDBStore(DATABASE, DB_VERSION, createDBStore);
