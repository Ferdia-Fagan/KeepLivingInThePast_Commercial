...
import WindowTabsStateManager from "../../../../src/background/browser_state_management/tabs/WindowTabsStateManager";
import WindowsStateManager from "../../../../src/background/browser_state_management/windows/WindowsStateManager";
...
describe('constructor', function () {
    it('constructor', function() {
        ...
        let aWindowsStateManager = new WindowsStateManager(1,sampleWindowTabsStateManager);
    ...
    it('addNewWindowOpened', function(){
        let aWindowsStateManager = new WindowsStateManager(1,new WindowTabsStateManager());
