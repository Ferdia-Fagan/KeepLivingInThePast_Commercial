...
export interface DBInterface<STORE_T extends IndexObject,
...
//     new <STORE_T extends IndexObject, T extends layer0_db<STORE_T>> (storeName: string, layer0_db: IDBDatabase): T
// }
//
// export async function builder<STORE_T extends IndexObject, T extends layer0_db<STORE_T>>(
